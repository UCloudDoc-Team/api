...
|[ListUKafkaInstance](api/ukafka-api/list_ukafka_instance)|获取实例列表信息|
|[ListUKafkaTopics](api/ukafka-api/list_ukafka_topics)|获取 kafka 实例 topic  列表信息|
|[ModifyUKafkaInstanceType](api/ukafka-api/modify_ukafka_instance_type)|规格升降级|
|[ResizeUKafkaDisk](api/ukafka-api/resize_ukafka_disk)|磁盘扩容|
