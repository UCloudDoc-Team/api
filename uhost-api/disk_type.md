...
| O   | 快杰型 O   | RSSD云盘 + RSSD云盘 <br> RSSD云盘 + 普通云盘 <br> RSSD云盘 + SSD云盘  |
| OS   | 快杰S型 OS | RSSD云盘 + RSSD云盘 <br> RSSD云盘 + 普通云盘 <br> RSSD云盘 + SSD云盘 |
| OMAX   | 快杰MAX型 OMAX | RSSD云盘 + RSSD云盘 <br> RSSD云盘 + 普通云盘 <br> RSSD云盘 + SSD云盘 |
| OPRO   | 快杰PRO型 OPRO | RSSD云盘 + RSSD云盘 <br> RSSD云盘 + 普通云盘 <br> RSSD云盘 + SSD云盘 |
