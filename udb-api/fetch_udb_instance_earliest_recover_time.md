...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=FetchUDBInstanceEarliestRecoverTime)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `FetchUDBInstanceEarliestRecoverTime`                        | **Yes** |
