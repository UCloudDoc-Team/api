# UDB高可用实例升级为Sentinel版本（不带HAProxy）升级耗时5-10秒 - SwitchUDBHAToSentinel
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `SwitchUDBHAToSentinel`                        | **Yes** |
...
| **ForceSwitch** | boolean | 是否跳过预检查强制升级。 |No|
