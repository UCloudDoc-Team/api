...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=PromoteUDBSlave)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `PromoteUDBSlave`                        | **Yes** |
...
| **IsForce** | boolean | 是否强制(如果从库落后可能会禁止提升)，默认false 如果落后情况下，强制提升丢失数据 |No|
