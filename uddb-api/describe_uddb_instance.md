...
| **CreateTime** | int | UDDB实例创建时间，采用UTC计时时间戳 |No|
| **ExpiredTime** | int | UDDB实例过期时间，采用UTC计时时间戳 |No|
...
| **DataNodeCount** | int | 数据节点个数 |No|
| **DataNodeMemory** | int | 数据节点的内存配置, 单位：MB |No|
| **DataNodeDiskSpace** | int | 数据节点的磁盘大小配置. 单位: GB |No|
| **DataNodeSlaveCount** | int | 每个数据节点的只读实例个数. |No|
...
|:---|:---|:---|:---|
| **Id** | string | 数据节点ID |No|
| **Memory** | int | 数据节点的内存配置, 单位：MB |No|
| **DiskSpace** | int | 数据节点的磁盘大小配置. 单位: GB |No|
| **SlaveCount** | int | 数据节点的只读实例个数. |No|
