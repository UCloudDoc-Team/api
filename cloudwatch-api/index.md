...
|[GetMetricDataAggregationMethod](api/cloudwatch-api/get_metric_data_aggregation_method)|获取指标数据聚合方式|
|[GetProductHighPrecisionMetrics](api/cloudwatch-api/get_product_high_precision_metrics)|获取云产品关联的高精度指标列表|
