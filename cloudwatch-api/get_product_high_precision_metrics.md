# 获取云产品关联的高精度指标列表 - GetProductHighPrecisionMetrics
...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=GetProductHighPrecisionMetrics)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `GetProductHighPrecisionMetrics`                        | **Yes** |
...
```
https://api.ucloud.cn/?Action=GetProductHighPrecisionMetrics
&ProductKey=jMnPgQdw
```
...
```json
{
  "Action": "GetProductHighPrecisionMetricsResponse",
  "Data": {
    "List": [
      {
        "ChartLabel": "",
