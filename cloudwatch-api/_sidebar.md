<div class="sidebar_title icon__cloudwatch">云监控 CloudWatch</div>
...
- **API**
    ...
    - [获取云产品关联的高精度指标列表 - GetProductHighPrecisionMetrics](api/cloudwatch-api/get_product_high_precision_metrics)
