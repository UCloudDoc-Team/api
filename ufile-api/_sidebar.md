...
- **管理类 API**
    - [添加跨域规则 - AddCORSRule](api/ufile-api/add_cors_rule)
    - [添加SSL证书 - AddUFileSSLCert](api/ufile-api/add_ufile_ssl_cert)
    - [绑定自定义域名 - BindBucketDomain](api/ufile-api/bind_bucket_domain)
    - [购买资源包 - BuyUFilePkg](api/ufile-api/buy_ufile_pkg)
    ...
    - [创建解压缩规则 - CreateUdsRule](api/ufile-api/create_uds_rule)
    - [删除Bucket - DeleteBucket](api/ufile-api/delete_bucket)
    - [删除跨域规则 - DeleteCORSRule](api/ufile-api/delete_cors_rule)
    - [删除生命周期管理 - DeleteUFileLifeCycle](api/ufile-api/delete_ufile_life_cycle)
    - [删除资源包(退费) - DeleteUFilePkg](api/ufile-api/delete_ufile_pkg)
    - [删除SSL证书 - DeleteUFileSSLCert](api/ufile-api/delete_ufile_ssl_cert)
    ...
    - [查询可购买的资源包列表 - DescribeUFileAvailablePkg](api/ufile-api/describe_ufile_available_pkg)
    - [获取生命周期信息 - DescribeUFileLifeCycle](api/ufile-api/describe_ufile_life_cycle)
    - [查询已购买的资源包列表 - DescribeUFilePkg](api/ufile-api/describe_ufile_pkg)
    - [查询资源包使用明细 - DescribeUFilePkgUsage](api/ufile-api/describe_ufile_pkg_usage)
    ...
    - [获取解压缩规则信息 - DescribeUdsRule](api/ufile-api/describe_uds_rule)
    - [获取bucket配额 - GetBucketQuota](api/ufile-api/get_bucket_quota)
    ...
    - [资源包续费 - RenewUFilePkg](api/ufile-api/renew_ufile_pkg)
    - [设置bucket配额 - SetBucketQuota](api/ufile-api/set_bucket_quota)
    - [设置项目地域配额 - SetProjectRegionQuota](api/ufile-api/set_project_region_quota)
    - [设置对象存储防盗链 - SetUFileReferer](api/ufile-api/set_ufile_referer)
    - [更改Bucket属性 - UpdateBucket](api/ufile-api/update_bucket)
    - [修改bucket静态网页配置 - UpdateBucketStaticPageRule](api/ufile-api/update_bucket_static_page_rule)
    - [更新跨域规则 - UpdateCORSRule](api/ufile-api/update_cors_rule)
    - [更新生命周期管理 - UpdateUFileLifeCycle](api/ufile-api/update_ufile_life_cycle)
    - [更新SSL证书 - UpdateUFileSSLCert](api/ufile-api/update_ufile_ssl_cert)
...
- **数据类 API**
  ...
  * [获取正在执行的分片信息-ListParts](api/ufile-api/get_multi_upload_part)
