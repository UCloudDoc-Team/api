# 更新UWAN虚拟路由器属性 - UpdatePOPGWAttribute
...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=UpdatePOPGWAttribute)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `UpdatePOPGWAttribute`                        | **Yes** |
...
| **PopGwId** | string | UWAN虚拟路由器资源ID |**Yes**|
| **Name** | string | 资源名称 |No|
| **Remark** | string | 备注 |No|
...
```
https://api.ucloud.cn/?Action=UpdatePOPGWAttribute
&Region=cn-zj
&Zone=cn-zj-01
&ProjectId=XEDjnEcB
&PopGwId=WUddJKch
