...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=UpdateExportLine)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `UpdateExportLine`                        | **Yes** |
...
| **Bandwidth** | string | 带宽大小（仅自定义套餐支持修改） |**Yes**|
...
```
https://api.ucloud.cn/?Action=UpdateExportLine
&ProjectId=wVqCMUKD
&ResourceId=pCVEztFY
&Bandwidth=VTrloxAf
```
...
```json
{
  "Action": "UpdateExportLineResponse",
  "Message": "tdjAMuhM",
  "RetCode": 0
}
```
