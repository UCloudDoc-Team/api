...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=DeleteCEGateway)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `DeleteCEGateway`                        | **Yes** |
...
```
https://api.ucloud.cn/?Action=DeleteCEGateway
&Region=cn-zj
&Zone=cn-zj-01
&ProjectId=BnExmoWZ
&VPNId=imESqtTe
...
```json
{
  "Action": "DeleteCEGatewayResponse",
  "Message": "BnyRdsgY",
  "RequestId": "ZKnPlLpn",
  "RetCode": 0
}
