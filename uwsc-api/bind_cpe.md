...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=BindCPE)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `BindCPE`                        | **Yes** |
...
```
https://api.ucloud.cn/?Action=BindCPE
&ProjectId=GwDIiuya
&RequestID=dYIOkbzl
&Name=xZBuUZms
&Remark=HvvRkrSg
