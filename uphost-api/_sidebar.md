...
- **API**
    ...
    - [创建裸金属2.0用户自定义镜像 - CreatePHostImage](api/uphost-api/create_phost_image)
    ...
    - [修改物理云自定义镜像信息 - ModifyPHostImageInfo](api/uphost-api/modify_phost_image_info)
    ...
    - [关闭物理机 - StopPHost](api/uphost-api/stop_phost)
    - [删除物理机 - TerminatePHost](api/uphost-api/terminate_phost)
    - [删除裸金属2.0用户自定义镜像 - TerminatePHostImage](api/uphost-api/terminate_phost_image)
