...
欢迎您选择 资源标签（Label），API 适合通过编写程序，自动化管理和编排云上资源的场景。
...
接下来浏览 [Label API 索引](api/label-api/index.md)，找到希望调用的 API 之后，挑选合适的方式来调用。


您可以选择以下方式中的任意一种，发起 API 请求：
- Label SDK / [Go](https://github.com/ucloud/ucloud-sdk-go) /
