...
- **API**
    ...
    - [获取GlobalSSH流量统计数据 - GetGlobalSSHTraffic](api/pathx-api/get_global_ssh_traffic)
    ...
    - [修改GlobalSSH 源站信息 - ModifyGlobalSSHOriginInfo](api/pathx-api/modify_global_ssh_origin_info)
