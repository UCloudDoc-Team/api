...
- **API**
    ...
    - [创建统一接入加速实例端口 - CreateUGA3Port](api/pathx-api/create_uga3_port)
    ...
    - [删除全球统一接入转发实例 - DeleteUGA3Instance](api/pathx-api/delete_uga3_instance)
    - [删除统一接入加速实例转发器 - DeleteUGA3Port](api/pathx-api/delete_uga3_port)
    ...
    - [获取全球接入源站可选列表 - DescribeUGA3Area](api/pathx-api/describe_uga3_area)
    - [获取全球统一接入加速服务加速配置信息 - DescribeUGA3Instance](api/pathx-api/describe_uga3_instance)
    - [获取全球接入UGA3线路加速优化情况 - DescribeUGA3Optimization](api/pathx-api/describe_uga3_optimization)
    ...
    - [获取全地域加速监控信息 - GetUGA3Metric](api/pathx-api/get_uga3_metric)
