...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=Verify)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `Verify`                        | **Yes** |
...
| **SignatureValid** | boolean | 签名是否有效。 |**Yes**|
| **SigningAlgorithm** | string | 使用的签名算法。取值：RSASSA_PSS_SHA_256、RSASSA_PSS_SHA_384、RSASSA_PSS_SHA_512、RSASSA_PKCS1_V1_5_SHA_256、RSASSA_PKCS1_V1_5_SHA_384、RSASSA_PKCS1_V1_5_SHA_512、ECDSA_SHA_256、ECDSA_SHA_384、ECDSA_SHA_512。 |**Yes**|
...
```
https://api.ucloud.cn/?Action=Verify
&Region=cn-zj
&ProjectId=RGkufHOJ
&Key=vnuGQwLo
```
