...
| **OrderType** | string | 订单类型 (筛选项, 默认全部)	 |No|
| **ChargeType** | string | 计费方式 (筛选项, 默认全部)	 |No|
...
| **ResourceTypes.N** | string | 产品类型 (筛选项, 默认全部),<br />支持多筛选，多筛选请在请求参数中添加多个字段<br />例<br />ResourceTypes.0: uhost，<br />ResourceTypes.1: udisk，<br />ResourceTypes.2: udb， |No|
