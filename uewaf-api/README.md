...
* [UEWAF攻击源IP数概览-StatWafAttackSrcTrend](api/uewaf-api/stat_waf_attack_src_trend)
* [攻击发生次数概览-StatWafAttacksTrend](api/uewaf-api/stat_waf_attacks_trend)
* [UEWAFQPS趋势-StatWafQPSTrend](api/uewaf-api/stat_waf_qps_trend)
* [UEWAF上行流量趋势-StatWafRXTrend](api/uewaf-api/stat_waf_reqs_trend)
* [UEWAF请求数趋势-StatWafReqsTrend](api/uewaf-api/stat_waf_rx_trend)
* [WAF下行流量趋势-StatWafTXTRend](api/uewaf-api/stat_waf_txt_rend)
* [删除并停止WAF服务-StopWafService](api/uewaf-api/stop_waf_service)
