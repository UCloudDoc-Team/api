# 获取算力平台共享镜像列表 - DescribeCompShareSharingImages
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `DescribeCompShareSharingImages`                        | **Yes** |
...
| **ImageSet** | array[[*CompShareImage*](#CompShareImage)] | 共享镜像列表 |**Yes**|
...
```
https://api.ucloud.cn/?Action=DescribeCompShareSharingImages
&Region=cn-zj
&Zone=cn-zj-01
&ProjectId=DXBIkrEA
&CompShareImageId=hTxvrWRX
&Offset=5
&Limit=4
```
  ...
  "ImageSet": [
    {
      "AuthInfo": 5,
      "Author": "THzsAoFI",
      "CompShareImageId": "ABXzSYHE",
      "Container": "HmNaUuJD",
      "Cover": "sbDaCuws",
      "CreateTime": "xwYARPtt",
      "CreatedCount": "HBCzGjdn",
      "Description": "BVhvYYtV",
      "FailedReason": "OdeMChPX",
      "FavoritesCount": "kGcNMdyJ",
      "ImageOwnerAlias": "ZMUGRdnr",
      "ImageType": "BOALYbGm",
      "IsOfficial": false,
      "Name": "ZSPINakJ",
      "Price": 2.59279,
