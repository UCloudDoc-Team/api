# 获取某个地域下可售/售罄的所有机型信息 - DescribeAvailableCompShareInstanceTypes
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `DescribeAvailableCompShareInstanceTypes`                        | **Yes** |
...
| **InstanceType** | string | 实例类型，枚举值["uhost", "spot"] |**Yes**|
...
```
https://api.ucloud.cn/?Action=DescribeAvailableCompShareInstanceTypes
&Region=cn-zj
&Zone=cn-zj-01
&ProjectId=akuzpnAV
&MachineTypes.N=BsMPKWvM
&InstanceType=YLnFsgcY
```
  ...
  "AvailableInstanceTypes": [
    {
      ...
      "GraphicsMemory": {},
      "InstanceType": "OwhTtQoO",
      "MachineClass": "ICHrsVfN",
      "MachineSizes": [
        {
          "Collection": [
            {
