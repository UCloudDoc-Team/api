# 获取算力平台实例价格 - GetCompShareInstancePrice
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `GetCompShareInstancePrice`                        | **Yes** |
...
```
https://api.ucloud.cn/?Action=GetCompShareInstancePrice
&Region=cn-zj
&Zone=cn-zj-01
&ProjectId=iXFpZYkj
&ChargeType=dqHLmKam
...
&Memory=ygijCDQM
&Gpu=CNcTqlLl
&CompShareImageId=HBQbfxur
&Disks.N.Type=kFNSpqsQ
&Disks.N.Size=1
&Disks.N.IsBoot=false
&GpuType=uwtUkrEB
```
...
```json
{
  ...
  "ListPriceDetail": [
    {
      "ChargeType": "rKMUdaQa",
      "CompShareImage": 2.44633,
      "Disks": 8.32967,
      "Instance": 8.26477,
      "ListPrice": "IKjEKvgP",
      "OriginalPrice": 5.51394
    }
  ],
  "OriginalPriceDetail": [
    {
      "ChargeType": "FWBOoRHi",
      "CompShareImage": 6.69774,
      "Disks": 5.63631,
      "Instance": 8.53191,
      "ListPrice": "PBWZsmHg",
      "OriginalPrice": 6.27931
    }
  ],
  "PriceDetail": [
    {
      "ChargeType": "ywhYYEkR",
      "CompShareImage": 2.69397,
      "Disks": 3.37659,
      "Instance": 4.68554,
      "ListPrice": "ZBrnJyMd",
      "OriginalPrice": 4.97496
    }
  ],
  "RetCode": 0
}
