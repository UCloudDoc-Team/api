# 个人中心社区镜像查询 - DescribeSelfCommunityImages
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `DescribeSelfCommunityImages`                        | **Yes** |
...
| **ImageSetGroup** | array[[*CompshareImageGroup*](#CompshareImageGroup)] | 镜像列表 |**Yes**|
| **TotalCount** | int | 镜像总数 |**Yes**|
| **AvailableTotalCount** | int | 仅计算当前ImageSetGroup中已发布的镜像信息，若某个Group中不存在已上线，则不统计 |**Yes**|
...
```
https://api.ucloud.cn/?Action=DescribeSelfCommunityImages
&Region=cn-zj
&Zone=cn-zj-01
&ProjectId=zWpxtcSb
&CompShareImageId=PVNDpQnD
&GroupId=nBkSWwSz
```
...
```json
{
  "Action": "DescribeSelfCommunityImagesResponse",
  "AvailableTotalCount": 8,
  "ImageSetGroup": [
    "xLsJeEEx"
  ],
  "RetCode": 0,
