...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `UpdateISMSSignature`                        | **Yes** |
...
| **SigId** | string | 签名ID，支持以数组的方式，举例，以SigIds.0、SigIds.1...SigIds.N方式传入    |**Yes**|
...
```
https://api.ucloud.cn/?Action=UpdateISMSSignature
&ProjectId=EzTMVMbN
&SigId=tmDOLGUU
&SigContent=shVstnzt
&SigType=5
...
```json
{
  "Action": "UpdateISMSSignatureResponse",
  "Message": "UMGZadXP",
  "RetCode": 0
}
```
