...
| **OperatorName** | string | 弹性IP线路，枚举值：国际线路， International；BGP线路：Bgp；精品BGP：BGPPro。<br /><br />使用BGP线路的地域：北京二、金融云-华东（上海）、华东（上海2）、华南（广州）等，其他地域均使用国际线路。<br />使用BGPPro线路的地域：香港 |**Yes**|
