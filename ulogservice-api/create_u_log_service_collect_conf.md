# 创建采集配置 - CreateULogServiceCollectConf
...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=CreateULogServiceCollectConf)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `CreateULogServiceCollectConf`                        | **Yes** |
...
```
https://api.ucloud.cn/?Action=CreateULogServiceCollectConf
&Region=cn-zj
&Zone=cn-zj-01
&ProjectId=INlNGZEm
&InstanceId=UDGfnhKj
&TopicId=FRGijNdo
&CollectMode=pTKTbpxF
&CollectConf=ObizVYRC
&CollectPath=kgYjWTjN
&CollectConfName=ZxNZFMlJ
&Keys.N=xPzkQMjP
&Delimiter=TMXcfZEy
&MatchRule=dMOSRNqT
&ExtractRule=CEWufsPB
&UnMatchKey=RNxEMhXx
&FilePaths.N.Path=UUpEbfyD
&FilePaths.N.File=xXGSdbAO
&Keys.N=nGSPjTul
&Delimiter=xLqoIrQt
&MatchRule=wXfZVszo
&ExtractRule=YZqObTzX
&UnMatchKey=SNDCEXZt
&FilePaths.N.Path=YsrLVbPD
&FilePaths.N.File=zVNNlOCu
&Keys.N=KCzzPGUR
&Delimiter=oraJEdHB
&MatchRule=MpqYdDrI
&ExtractRule=KikWXGFl
&UnMatchKey=WZOgQbav
&FilePaths.N.Path=cQIiFXfA
&FilePaths.N.File=XbyRKRTY
```
...
```json
{
  "Action": "CreateULogServiceCollectConfResponse",
  "Message": "eBmaLjBL",
  "RetCode": 0
}
```
