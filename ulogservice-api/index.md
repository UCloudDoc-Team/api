...
| API | 描述信息 |
|:---|:---|
|[BindULogServiceGroupToCollectConf](api/ulogservice-api/bind_u_log_service_group_to_collect_conf)|日志主题采集配置绑定机器组|
|[CreateULogServiceCollectConf](api/ulogservice-api/create_u_log_service_collect_conf)|创建采集配置|
|[CreateULogServiceLogSet](api/ulogservice-api/create_u_log_service_log_set)|创建日志集|
|[CreateULogServiceMachineGroup](api/ulogservice-api/create_u_log_service_machine_group)|创建机器组|
|[CreateULogServiceTopic](api/ulogservice-api/create_u_log_service_topic)|创建ULogService主题|
|[DeleteULogServiceCollectConf](api/ulogservice-api/delete_u_log_service_collect_conf)|删除日志主题采集配置|
|[DeleteULogServiceLogSet](api/ulogservice-api/delete_u_log_service_log_set)|删除日志集|
...
|[ListULogServiceTopic](api/ulogservice-api/list_u_log_service_topic)|获取ULogService主题|
