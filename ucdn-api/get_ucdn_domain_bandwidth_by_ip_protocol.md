# 获取域名带宽数据按ip协议【新】 - GetUcdnDomainBandwidthByIpProtocol
...
- [UAPI 浏览器](https://console.ucloud.cn/uapi/detail?id=GetUcdnDomainBandwidthByIpProtocol)
...
| 参数名 | 类型 | 描述信息 | 必填 |
|:---|:---|:---|:---|
| **Action**     | string  | 对应的 API 指令名称，当前 API 为 `GetUcdnDomainBandwidthByIpProtocol`                        | **Yes** |
...
| **IpProtocol** | string | 协议，ipv4、ipv6 |**Yes**|
...
```
https://api.ucloud.cn/?Action=GetUcdnDomainBandwidthByIpProtocol
&ProjectId=mwJINqhT
&Type=8
&DomainId.n=evUeDPDj
&Areacode=ZYoVRdyx
...
```json
{
  "Action": "GetUcdnDomainBandwidthByIpProtocolResponse",
  "BandwidthTrafficList": [
    {
      "CdnBandwidth": 4.33645,
      "Time": 7,
      "Traffic": 6.58469
    }
  ],
