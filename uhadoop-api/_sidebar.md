<div class="sidebar_title icon__uhadoop">托管Hadoop集群 UHadoop</div>


- [概览](api/uhadoop-api/README.md)
- [索引](api/uhadoop-api/index.md)
- **API**
    - [给集群添加节点 - AddUHadoopInstanceNode](api/uhadoop-api/add_uhadoop_instance_node)
    - [新建集群 - CreateUHadoopInstance](api/uhadoop-api/create_uhadoop_instance)
    - [删除集群 - DeleteUHadoopInstance](api/uhadoop-api/delete_uhadoop_instance)
    ...
    - [扩容集群节点磁盘 - UpgradeUHadoopNodeDisk](api/uhadoop-api/upgrade_uhadoop_node_disk)
